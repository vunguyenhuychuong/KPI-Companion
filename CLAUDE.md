...
- [x] **Daily Connected Source Scan** — Agent tự chủ quét các nguồn OAuth đã kết nối mỗi ngày, dùng AI tách bằng chứng công việc, lọc mục không liên quan KPI/độ tin cậy thấp/trùng lặp, tạo nháp nhật ký trong Autonomous Inbox; chỉ ghi WorkItem và cộng tiến độ KPI sau khi user xác nhận.
