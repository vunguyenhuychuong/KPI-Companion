...
def _polish_agent_text(text: str) -> str:
    replacements = {
        ...
        "Act": "",
        "Remember": "",
        "đang ở trạng thái se_lam": "đã lên kế hoạch",
        "đang ở trạng thái dang_lam": "đang thực hiện",
        "đang ở trạng thái da_lam": "hoàn thành",
        "đang ở trạng thái phat_sinh": "phát sinh ngoài kế hoạch",
        "đang ở trạng thái loai_bo": "đã hủy bỏ",
        "trạng thái se_lam": "đã lên kế hoạch",
        "trạng thái dang_lam": "đang thực hiện",
        "trạng thái da_lam": "hoàn thành",
        "trạng thái phat_sinh": "phát sinh ngoài kế hoạch",
        "trạng thái loai_bo": "hủy bỏ",
        "da_lam": "hoàn thành",
